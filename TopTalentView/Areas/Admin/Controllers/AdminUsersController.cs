...
namespace TopTalentView.Areas.Admin.Controllers
{
    ...
    public class AdminUsersController : Controller
    {
        ...
        public AdminUsersController(TopTalentContext context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserEmail,UserPassword,UserName,UserPhone,UserAddress,UserDescription,UserStatus")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserEmail,UserPassword,UserName,UserPhone,UserAddress,UserDescription,UserStatus")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
